...
# curve25519-elligator2 [![](https://buildstats.info/crate/curve25519-elligator2)](https://crates.io/crates/curve25519-elligator2) [![](https://img.shields.io/docsrs/curve25519-elligator2)](https://docs.rs/curve25519-elligator2) [![CI](https://github.com/jmwample/curve25519-dalek/actions/workflows/curve25519-elligator2.yml/badge.svg?branch=main)](https://github.com/jmwample/curve25519-dalek/actions/workflows/curve25519-elligator2.yml)

## THIS IS A FORK FOR CONVENIENCE

This fork contains an implementation of elligator2 that is awaiting potential
inclusion in the mainstream `curve25519-dalek` crate. This crate exists for
use in the interim period. As such, this crate:
1. may change its API to conform to needs of the upstream source
2. will be yanked if the feature is merged into the upstream source.
...
Below is the documentation for the underlying `curve25519-dalek` crate.
